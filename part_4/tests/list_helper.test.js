...
describe('general checks on blogs', () => {
  ...
  test('blog posts increased by one', async () => {
    const newBlog = {
      'title': 'Harrys Blog',
      'author': 'Harry',
      'url': 'www.harry.com',
  ...
  test('likes property does not exist default 0', async () => {
    ...
    // expect 0 for when likes key does not exist
    expect(response[2].likes).toBe(0)
  })


  test('title or url exists', async () => {
    const newBlog = {
      'author': 'Harry',
      'likes': 0
    }
...
describe('update of a note', () => {
  test('succeeds with status code 200 if id is valid', async () => {
    ...
    const updatedBlog = {
      'title': 'Bills Blog-reboot',
      'author': 'Mariya Takeuchi-reboot',
      'url': 'www.google.com',
      'likes': 10
    }
    ...
    expect(blogsAtEnd[0].title).toBe('Bills Blog-reboot')
    expect(blogsAtEnd[0].author).toBe('Mariya Takeuchi-reboot')
...
describe('User with most blogs', () => {
  ...
  test('Returns the user with the most blogs', () => {
...
describe('User with most likes', () => {
  ...
  test('Returns the user with the most likes', () => {
